...
public class Constants {
    ...
    public static final String ACTION_THING_INIT = "com.example.njames.myfirstapp.action.THING_INIT";
    ...
    public static final String EXTRA_LABELS = "com.example.njames.myfirstapp.extra.LABELS";
    public static final String EXTRA_THRESHOLDS_UPPER = "com.example.njames.myfirstapp.extra.THRESHOLDS_UPPER";
    public static final String EXTRA_THRESHOLDS_LOWER = "com.example.njames.myfirstapp.extra.THRESHOLDS_LOWER";
    ...
    public static final String EMAIL = "com.example.njames.myfirstapp.preferences.AUTH.EMAIL";
    public static final String PASSWORD = "com.example.njames.myfirstapp.preferences.AUTH.PASSWORD";
    public static final String USERID = "com.example.njames.myfirstapp.preferences.AUTH.USERID";
